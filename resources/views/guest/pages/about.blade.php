<x-app-layout title="About Us & How it Works | MyCrip">
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            ...
            <nav class="flex justify-center mb-8" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2 text-sm">
                    ...
                    <li class="text-[#C6A664] font-semibold">About Us</li>
                </ol>
            </nav>

            <h1 class="text-5xl md:text-6xl font-black mb-6 tracking-tight">
                Redefining Real Estate <br>
                <span id="typing-text-about" style="color: #C6A664;" class="after:content-['|'] after:animate-ping after:text-[#C6A664] after:ml-1"></span>
            </h1>
            <script>
    ...
    <div class="py-24 bg-gray-50 border-b border-gray-100">
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16">
                <!-- Mission -->
                <div class="bg-white p-12 rounded-[2.5rem] shadow-xl border-t-4 border-[#001F3F] transform hover:-translate-y-2 transition-transform duration-300">
                    <div class="w-16 h-16 bg-[#001F3F]/5 text-[#001F3F] rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    </div>
                    <h2 class="text-3xl font-black text-[#001F3F] mb-6">Our Mission</h2>
                ...
                <!-- Vision -->
                <div class="bg-white p-12 rounded-[2.5rem] shadow-xl border-t-4 border-[#C6A664] transform hover:-translate-y-2 transition-transform duration-300">
                    <div class="w-16 h-16 bg-[#C6A664]/10 text-[#C6A664] rounded-2xl flex items-center justify-center mb-8">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                    </div>
                    <h2 class="text-3xl font-black text-[#001F3F] mb-6">Our Vision</h2>
                    <p class="text-gray-600 leading-relaxed text-lg">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="p-8 bg-gray-50 rounded-3xl border border-gray-100 hover:shadow-xl transition-all group">
                    ...
                    <h3 class="text-xl font-bold text-[#001F3F] mb-4">Smart Fraud Detection</h3>
                ...
                <div class="p-8 bg-gray-50 rounded-3xl border border-gray-100 hover:shadow-xl transition-all group">
                    ...
                    <h3 class="text-xl font-bold text-[#001F3F] mb-4">Verified Professionals</h3>
                    <p class="text-gray-600 leading-relaxed text-sm">
                ...
                <div class="p-8 bg-gray-50 rounded-3xl border border-gray-100 hover:shadow-xl transition-all group">
                    ...
                    <h3 class="text-xl font-bold text-[#001F3F] mb-4">Real-Time Insights</h3>
                    <p class="text-gray-600 leading-relaxed text-sm">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                ...
                <div class="bg-white p-10 rounded-[3rem] shadow-sm border border-gray-100">
                    <div class="flex items-center mb-8">
                        <div class="w-12 h-12 bg-[#C6A664] text-white rounded-2xl flex items-center justify-center mr-4 shadow-lg shadow-gold-100">
                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                        </div>
                        <h3 class="text-2xl font-black text-[#001F3F]">For House Hunters</h3>
                    </div>

                    <div class="space-y-8">
                        <div class="flex items-start">
                            <span class="w-8 h-8 rounded-xl bg-gray-100 text-[#001F3F] font-black flex items-center justify-center shrink-0 mr-4">1</span>
                            <div>
                                <h4 class="font-bold text-[#001F3F]">Browse & Filter</h4>
                        ...
                        <div class="flex items-start">
                            <span class="w-8 h-8 rounded-xl bg-gray-100 text-[#001F3F] font-black flex items-center justify-center shrink-0 mr-4">2</span>
                            <div>
                                <h4 class="font-bold text-[#001F3F]">Check Fraud Flags</h4>
                        ...
                        <div class="flex items-start">
                            <span class="w-8 h-8 rounded-xl bg-gray-100 text-[#001F3F] font-black flex items-center justify-center shrink-0 mr-4">3</span>
                            <div>
                                <h4 class="font-bold text-[#001F3F]">Connect Safely</h4>
                ...
                <div class="bg-[#001F3F] p-10 rounded-[3rem] shadow-xl text-white">
                    ...
                    <div class="space-y-8">
                        <div class="flex items-start">
                            <span class="w-8 h-8 rounded-xl bg-white/10 text-[#C6A664] font-black flex items-center justify-center shrink-0 mr-4 border border-white/20">1</span>
                            <div>
                        ...
                        <div class="flex items-start">
                            <span class="w-8 h-8 rounded-xl bg-white/10 text-[#C6A664] font-black flex items-center justify-center shrink-0 mr-4 border border-white/20">2</span>
                            <div>
                        ...
                        <div class="flex items-start">
                            <span class="w-8 h-8 rounded-xl bg-white/10 text-[#C6A664] font-black flex items-center justify-center shrink-0 mr-4 border border-white/20">3</span>
                            <div>
    ...
    <!-- Statistics Section -->
    <div class="py-20 bg-[#001F3F] text-white overflow-hidden relative border-t-4 border-[#C6A664]">
        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/10">
                <div class="px-4">
                    <span class="block text-4xl md:text-5xl font-black text-[#C6A664] mb-2">{{ number_format($activePropertiesCount) }}+</span>
                    <span class="text-gray-300 font-medium uppercase tracking-wider text-sm">Active Properties</span>
                </div>
                <div class="px-4">
                    <span class="block text-4xl md:text-5xl font-black text-[#C6A664] mb-2">{{ number_format($verifiedAgentsCount) }}+</span>
                    <span class="text-gray-300 font-medium uppercase tracking-wider text-sm">Verified Agents</span>
                </div>
                <div class="px-4">
                    <span class="block text-4xl md:text-5xl font-black text-[#C6A664] mb-2">Zero</span>
                    <span class="text-gray-300 font-medium uppercase tracking-wider text-sm">Tolerance for Fraud</span>
                </div>
                <div class="px-4">
                    <span class="block text-4xl md:text-5xl font-black text-[#C6A664] mb-2">24/7</span>
    ...
    <div class="py-24 bg-white text-center">
        <div class="container mx-auto px-6">
            <h2 class="text-4xl font-black text-[#001F3F] mb-8">Ready to find your dream home?</h2>
            <div class="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
                <a href="{{ route('properties.index') }}" class="px-10 py-4 bg-[#001F3F] text-white font-bold rounded-2xl hover:bg-[#002b56] transition-all shadow-xl shadow-blue-900/20">Explore Listings</a>
                <a href="{{ route('register') }}" class="px-10 py-4 border-2 border-[#001F3F] text-[#001F3F] font-bold rounded-2xl hover:bg-gray-50 transition-all">Join as an Agent</a>
            </div>
        </div>
    </div>
</x-app-layout>
