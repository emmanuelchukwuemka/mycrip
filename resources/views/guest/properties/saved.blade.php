    ...
    <div class="bg-gray-50 min-h-screen py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between mb-10">
                <div>
                    <h1 class="text-3xl font-extrabold text-[#A85C2E] tracking-tight">Saved Properties</h1>
                    <p class="mt-2 text-gray-500 font-medium">Manage your favorite listings and tracks changes.</p>
                </div>
                <div class="bg-white p-2 rounded-xl border-2 border-[#2B1810]/20 shadow-sm">
                    <span class="px-4 py-1.5 bg-[#A85C2E] text-white text-xs font-bold rounded-lg uppercase tracking-widest">
            ...
            @if($savedProperties->isEmpty())
                <div class="bg-white rounded-3xl p-16 text-center shadow-xl border border-gray-100 max-w-2xl mx-auto">
                    <div class="w-24 h-24 bg-[#2B1810]/10 rounded-full flex items-center justify-center mx-auto mb-8">
                        <svg class="w-12 h-12 text-[#2B1810]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                        </svg>
                    </div>
                    <h2 class="text-2xl font-bold text-[#A85C2E] mb-4">No saved properties yet</h2>
                    ...
                    <a href="{{ route('properties.index') }}" 
                       class="inline-flex items-center justify-center px-8 py-4 bg-[#A85C2E] text-white font-bold rounded-2xl hover:bg-[#2B1810] transition-all duration-300 shadow-lg hover:shadow-[#A85C2E]/20 transform hover:-translate-y-1">
                        Explore Properties
                    </a>
                </div>
            @else
                        ...
                        <div class="group bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 flex flex-col h-full transform hover:-translate-y-2">
                            ...
                            <div class="relative aspect-[4/3] overflow-hidden">
                                ...
                                <div class="absolute top-4 left-4 flex flex-col gap-2">
                                    <span class="px-4 py-1.5 bg-white/90 backdrop-blur-md text-[#A85C2E] text-[10px] font-bold rounded-lg uppercase tracking-widest shadow-lg">
                            ...
                            <div class="p-6 flex flex-col flex-grow">
                                <div class="mb-4">
                                    <h3 class="text-xl font-bold text-[#A85C2E] line-clamp-1 group-hover:text-[#2B1810] transition-colors">{{ $property->title }}</h3>
                                    <p class="text-gray-500 flex items-center mt-2 text-sm font-medium">
                                        <svg class="w-4 h-4 mr-1 text-[#2B1810]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="mt-auto pt-4 flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div class="w-8 h-8 rounded-full bg-[#A85C2E] flex items-center justify-center text-white text-[10px] font-bold">
                                    ...
                                    <a href="{{ route('properties.show', $property->id) }}" 
                                       class="px-5 py-2.5 bg-[#2B1810]/10 text-[#2B1810] text-xs font-bold rounded-xl hover:bg-[#2B1810] hover:text-white transition-all duration-300">
                                        View Details
                                    </a>
                                </div>
                            </div>
