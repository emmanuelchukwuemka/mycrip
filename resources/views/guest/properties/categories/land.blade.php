            ...
            <div class="relative max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div class="text-center">
                    <div class="inline-flex items-center px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-white/20 shadow-lg">
                        ...
                        <span class="text-sm font-medium text-gray-700">Investment Opportunity</span>
                    </div>
                    <h1 class="mt-6 text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 tracking-tight">
                        Prime
                        <span class="bg-clip-text text-transparent" style="background: linear-gradient(to right, #001F3F, #C6A664); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Land</span>
                        Properties
                    </h1>
                    <p class="mt-6 max-w-3xl mx-auto text-xl md:text-2xl text-gray-600 leading-relaxed">
                        Discover valuable land investments with development potential, strategic locations, and exceptional growth opportunities.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
                    <div class="relative overflow-hidden rounded-t-2xl">
                        ...
                        <img 
                            ...
                            src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80" 
                            alt="Commercial Land"
                        >
                        ...
                        <div class="absolute bottom-4 left-4 right-4 z-20">
                            <div class="flex items-center justify-between">
                                <div class="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                                    <span class="text-sm font-medium text-gray-700">5 Acres</span>
                                </div>
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Downtown Area</p>
                            </div>
                            
                            <div class="prose prose-sm text-gray-600 leading-relaxed">
                                <p>
                                    Prime 5-acre commercial development site with excellent visibility, access to utilities, and approved zoning for mixed-use development.
                                </p>
                            </div>
                ...
                <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
                    <div class="relative overflow-hidden rounded-t-2xl">
                        ...
                        <img 
                            class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-500" 
                            src="https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80" 
                        ...
                        <div class="absolute bottom-4 left-4 right-4 z-20">
                            <div class="flex items-center justify-between">
                                <div class="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                                    <span class="text-sm font-medium text-gray-700">2.5 Acres</span>
                                </div>
                                <div class="flex space-x-2">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                        Utilities
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Greenfield Development</p>
                            </div>
                            
                            <div class="prose prose-sm text-gray-600 leading-relaxed">
                                <p>
                                    Beautiful 2.5-acre residential subdivision plot with approved plans, utilities available, and excellent neighborhood potential.
                                </p>
                            </div>
                ...
                <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
                    <div class="relative overflow-hidden rounded-t-2xl">
                        ...
                        <img 
                            class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-500" 
                            src="https://images.unsplash.com/photo-1518709268805-4e9042af9f23?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80" 
                        ...
                        <div class="absolute bottom-4 left-4 right-4 z-20">
                            <div class="flex items-center justify-between">
                                <div class="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                                    <span class="text-sm font-medium text-gray-700">15 Acres</span>
                                </div>
                                <div class="flex space-x-2">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Rural Development</p>
                            </div>
                            
                            <div class="prose prose-sm text-gray-600 leading-relaxed">
                                <p>
                                    Expansive 15-acre agricultural investment with fertile soil, water access, and potential for organic farming or agro-tourism development.
                                </p>
                            </div>
            ...
            <div class="mt-16 text-center">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                    <h2 class="text-3xl font-bold mb-4" style="color: #001F3F;">Invest in Prime Land</h2>
                    <p class="text-gray-600 mb-8">Explore our complete collection of land investments and find the perfect opportunity for your development project.</p>
