            ...
            <div class="relative max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div class="text-center">
                    <div class="inline-flex items-center px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-white/20 shadow-lg">
                        ...
                        <span class="text-sm font-medium text-gray-700">Urban Living</span>
                    </div>
                    <h1 class="mt-6 text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 tracking-tight">
                        Modern
                        <span class="bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent">Apartments</span>
                    </h1>
                    <p class="mt-6 max-w-3xl mx-auto text-xl md:text-2xl text-gray-600 leading-relaxed">
                        Discover contemporary living spaces designed for comfort, style, and convenience in the heart of the city.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
                    <div class="relative overflow-hidden rounded-t-2xl">
                        ...
                        <img 
                            ...
                            src="https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80" 
                        ...
                        <div class="absolute bottom-4 left-4 right-4 z-20">
                            <div class="flex items-center justify-between">
                                <div class="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full">
                                    <span class="text-sm font-medium text-gray-700">2 Bedrooms</span>
                                </div>
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <div class="prose prose-sm text-gray-600 leading-relaxed">
                                <p>
                                    Spacious 2-bedroom apartment with panoramic city views, modern amenities, and premium finishes throughout.
                                </p>
                            </div>
                ...
                <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
                    <div class="relative overflow-hidden rounded-t-2xl">
                        ...
                        <img 
                            class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-500" 
                            src="https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80" 
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">City Center</p>
                            </div>
                            
                            <div class="prose prose-sm text-gray-600 leading-relaxed">
                                <p>
                                    Stylish studio apartment with open-concept design, floor-to-ceiling windows, and premium finishes.
                                </p>
                            </div>
                ...
                <div class="group relative bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
                    <div class="relative overflow-hidden rounded-t-2xl">
                        ...
                        <img 
                            class="w-full h-64 object-cover group-hover:scale-110 transition-transform duration-500" 
                            src="https://images.unsplash.com/photo-1580587771525-78b9dba3b914?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80" 
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Financial District</p>
                            </div>
                            
                            <div class="prose prose-sm text-gray-600 leading-relaxed">
                                <p>
                                    Premium 3-bedroom suite with executive finishes, private balcony, and access to exclusive amenities.
                                </p>
                            </div>
            ...
            <div class="mt-16 text-center">
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                    <h2 class="text-3xl font-bold text-gray-900 mb-4">Find Your Perfect Apartment</h2>
                    <p class="text-gray-600 mb-8">Browse our complete collection of available apartments and find your ideal urban living space.</p>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="{{ route('properties.index') }}" class="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
