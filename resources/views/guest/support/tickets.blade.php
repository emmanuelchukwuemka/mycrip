<x-agent-layout>
    <div class="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <a href="{{ route('support.tickets.create') }}" class="inline-flex items-center gap-2 px-8 py-4 bg-[#001F3F] text-white rounded-2xl font-bold hover:bg-[#002d5c] hover:shadow-xl hover:shadow-[#001F3F]/20 transition-all duration-300 active:scale-[0.98]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm">
                ...
                <h3 class="text-3xl font-black text-[#C6A664]">{{ $tickets->getCollection()->where('status', 'open')->count() }}</h3>
            </div>
            <div class="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm">
        ...
        <!-- FAQ Quick Links -->
        <div class="bg-gradient-to-br from-[#001F3F] to-[#00152B] rounded-[3rem] p-12 text-white overflow-hidden relative group">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center gap-10">
                ...
                <a href="{{ route('support.faq') }}" class="px-10 py-4 bg-amber-500 text-[#001F3F] rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-amber-400 transition-all duration-300 shadow-xl shadow-amber-500/20 active:scale-[0.98]">
                    Explore FAQ
                </a>
            </div>
        </div>
