    ...
    <div class="bg-gray-50 min-h-screen py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-4">
                <div>
                    <h1 class="text-3xl font-extrabold text-[#A85C2E] tracking-tight text-center md:text-left">My Inquiries</h1>
                ...
                <div class="flex justify-center">
                    <div class="bg-white p-2 rounded-xl border-2 border-[#2B1810]/20 shadow-sm inline-flex items-center">
                        <span class="px-4 py-1.5 bg-[#A85C2E] text-white text-xs font-bold rounded-lg uppercase tracking-widest leading-none">
            ...
            @if($inquiries->isEmpty())
                <div class="bg-white rounded-3xl p-16 text-center shadow-xl border border-gray-100 max-w-2xl mx-auto">
                    ...
                    <h2 class="text-2xl font-bold text-[#A85C2E] mb-4">No inquiries found</h2>
                                    ...
                                    <tr class="hover:bg-gray-50/50 transition-colors">
                                        <td class="px-8 py-6">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <p class="text-sm font-bold text-[#A85C2E] line-clamp-1 truncate max-w-[200px]">{{ $inquiry->property->title }}</p>
                                        ...
                                        <td class="px-8 py-6">
                                            <div class="flex items-center">
                                                <div class="w-8 h-8 rounded-full bg-[#2B1810]/20 flex items-center justify-center text-[#2B1810] font-black text-[10px]">
                                        ...
                                        <td class="px-8 py-6 text-right">
                                            <a href="{{ route('inquiries.show', $inquiry->id) }}" 
                                               class="inline-flex items-center px-4 py-2 bg-[#A85C2E] text-white text-xs font-bold rounded-xl hover:bg-[#2B1810] transition-all shadow-md">
                                                Details
