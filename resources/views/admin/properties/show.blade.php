    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            <div class="flex items-center space-x-3 mb-2">
                <a href="{{ route('admin.properties.index') }}" class="text-gray-500 hover:text-[#A85C2E] transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
                </a>
                <span class="text-sm text-gray-400">Back to Listings</span>
            </div>
            <h2 class="text-3xl font-bold" style="color: #A85C2E;">{{ $property->title }}</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
                <h4 class="text-lg font-bold mb-4" style="color: #A85C2E;">Property Gallery</h4>
            ...
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                <h4 class="text-xl font-bold mb-6" style="color: #A85C2E;">Listing Details</h4>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-6">
                    <div class="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                        ...
                        <p class="text-xl font-bold text-[#A85C2E] mt-1">{{ $property->bedrooms ?? 'N/A' }}</p>
                    </div>
                    <div class="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                        <span class="text-xs text-gray-400 uppercase font-bold tracking-wider">Bathrooms</span>
                        <p class="text-xl font-bold text-[#A85C2E] mt-1">{{ $property->bathrooms ?? 'N/A' }}</p>
                    </div>
                    <div class="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                        <span class="text-xs text-gray-400 uppercase font-bold tracking-wider">Toilets</span>
                        <p class="text-xl font-bold text-[#A85C2E] mt-1">{{ $property->toilets ?? 'N/A' }}</p>
                    </div>
                    <div class="p-4 bg-gray-50 rounded-2xl border border-gray-100">
                        <span class="text-xs text-gray-400 uppercase font-bold tracking-wider">Size</span>
                        <p class="text-sm font-bold text-[#A85C2E] mt-1 truncate">{{ $property->size ?? 'N/A' }}</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Features/Amenities -->
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                <h4 class="text-xl font-bold mb-6" style="color: #A85C2E;">Amenities & Features</h4>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 text-center relative overflow-hidden">
                <div class="absolute top-0 right-0 w-24 h-24 bg-[#2B1810]/5 -mr-8 -mt-8 rounded-full"></div>
                <span class="text-xs text-gray-400 uppercase font-bold tracking-widest">Listing Price</span>
                <div class="text-4xl font-extrabold text-[#A85C2E] mt-2 mb-1">
            ...
            <!-- Agent Info -->
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-gray-100">
                <h4 class="text-lg font-bold mb-6" style="color: #A85C2E;">Listing Agent</h4>
                <div class="flex items-center mb-6">
                    <div class="h-16 w-16 rounded-2xl overflow-hidden border-2 p-0.5" style="border-color: #2B1810;">
                    ...
                    <div class="ml-4">
                        <div class="text-lg font-bold text-[#A85C2E]">{{ $property->user->name }}</div>
