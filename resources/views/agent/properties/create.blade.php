                ...
                <div class="border-t border-gray-100 pt-10 mb-10" x-data="{ 
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <button type="button" @click="addGallery()" 
                                class="inline-flex items-center px-4 py-2 bg-[#C6A664] text-white text-sm font-bold rounded-xl hover:bg-[#B89654] transition-all shadow-lg shadow-[#C6A664]/20">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div class="md:col-span-1">
                                        ...
                                        <input type="text" :name="'sub_galleries[' + index + '][label]'" 
                                               ...
                                               class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-4 focus:ring-[#C6A664]/10 focus:border-[#C6A664] outline-none transition-all text-sm font-semibold" required>
                                    </div>
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="file" :name="'sub_galleries[' + index + '][images][]'" multiple accept="image/*"
                                               class="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:ring-4 focus:ring-[#C6A664]/10 outline-none transition-all text-sm file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-xs file:font-bold file:bg-[#001F3F] file:text-white hover:file:bg-[#C6A664] cursor-pointer" required>
                                    </div>
                                </div>
                            </div>
                        </template>
