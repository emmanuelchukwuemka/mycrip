<x-agent-layout>
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('agent.messages.index') }}" class="inline-flex items-center text-sm font-medium transition-colors" style="color: #C6A664;">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                ...
                @if($conversation->property)
                    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                        <div class="px-5 py-3 border-b border-gray-100" style="background: rgba(0, 31, 63, 0.02);">
                            <h3 class="text-sm font-bold" style="color: #001F3F;">Linked Property</h3>
                        </div>
                        <div class="p-6">
                            ...
                            <p class="text-lg font-black" style="color: #C6A664;">₦{{ number_format($conversation->property->price) }}</p>
