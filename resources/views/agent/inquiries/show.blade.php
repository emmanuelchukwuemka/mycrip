            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="flex items-center justify-between px-8 py-5 border-b border-gray-50 bg-gray-50/50">
                        ...
                        <div class="p-2 rounded-lg" style="background: rgba(168, 92, 46, 0.06);">
                            <svg class="w-5 h-5" style="color: #A85C2E;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-8">
                        <div class="flex items-center space-x-6">
                            <div class="flex-shrink-0">
                                <div class="h-20 w-20 rounded-2xl flex items-center justify-center text-white text-2xl font-bold shadow-lg" style="background-color: #A85C2E;">
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="flex items-center justify-between px-8 py-5 border-b border-gray-50 bg-gray-50/50">
                        ...
                        <div class="p-2 rounded-lg" style="background: rgba(43, 24, 16, 0.1);">
                            <svg class="w-5 h-5" style="color: #2B1810;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-8">
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            @endif
                            <div class="flex-1">
                                <h4 class="text-xl font-bold text-gray-800 group-hover:text-[#2B1810] transition-colors">{{ $inquiry->property->title }}</h4>
                                <p class="text-sm text-gray-400 mt-1">{{ $inquiry->property->city }}{{ $inquiry->property->state ? ', ' . $inquiry->property->state : '' }}</p>
                                
                                <div class="mt-4">
                                    <span class="text-2xl font-bold" style="color: #A85C2E;">{{ $inquiry->property->formatted_price ?? 'Contact for price' }}</span>
                                ...
                                <div class="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-100">
                                    ...
                                    <div class="text-center">
                                        <div class="p-2 rounded-xl mx-auto w-fit" style="background: rgba(168, 92, 46, 0.05);">
                                            <svg class="w-5 h-5" style="color: #A85C2E;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                                            </svg>
                                        </div>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-8">
                        <div class="rounded-2xl p-6" style="background: rgba(168, 92, 46, 0.02); border: 1px solid rgba(168, 92, 46, 0.06);">
                            <div class="flex items-start space-x-4">
                                <div class="flex-shrink-0 h-12 w-12 rounded-xl flex items-center justify-center text-white font-bold text-sm" style="background-color: #A85C2E;">
                                    {{ strtoupper(substr($inquiry->guest_name, 0, 2)) }}
                                </div>
                                <div class="flex-1">
            ...
            <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-center py-6">
                            @if($inquiry->status === 'new')
                                <span class="px-5 py-2.5 inline-flex items-center text-sm font-bold rounded-xl" style="background: rgba(43, 24, 16, 0.12); color: #2B1810;">
                                    <span class="w-2 h-2 rounded-full bg-[#2B1810] mr-2.5 animate-pulse"></span>
                                    New Inquiry
                                </span>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <a href="mailto:{{ $inquiry->guest_email }}" class="w-full inline-flex items-center px-5 py-3.5 text-[#A85C2E] font-bold rounded-xl hover:shadow-lg transition-all duration-300 group" style="background-color: #2B1810;">
                        ...
                        @if($inquiry->guest_phone)
                        <a href="tel:{{ $inquiry->guest_phone }}" class="w-full inline-flex items-center px-5 py-3.5 border-2 text-gray-700 bg-white font-bold rounded-xl hover:bg-gray-50 transition-all duration-200" style="border-color: rgba(168, 92, 46, 0.15);">
                        ...
                        @if($inquiry->guest_phone)
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $inquiry->guest_phone) }}" target="_blank" class="w-full inline-flex items-center px-5 py-3.5 border-2 text-gray-700 bg-white font-bold rounded-xl hover:bg-gray-50 transition-all duration-200" style="border-color: rgba(168, 92, 46, 0.15);">
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-3 pt-3 border-t border-gray-100">
                            <span class="text-lg font-bold" style="color: #A85C2E;">{{ $inquiry->property->formatted_price ?? 'Contact' }}</span>
                        </div>
                        <a href="{{ route('agent.properties.edit', $inquiry->property->id) }}" 
                           class="mt-4 w-full inline-flex items-center justify-center px-4 py-2.5 text-sm font-bold rounded-xl transition-all duration-200 text-white hover:shadow-lg" style="background-color: #A85C2E;">
