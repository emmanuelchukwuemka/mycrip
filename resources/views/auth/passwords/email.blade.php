        ...
        <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="mx-auto w-full max-w-md lg:w-96">
                <div class="text-center mb-8">
                    <a href="{{ route('login') }}" class="inline-flex items-center transition-colors" style="color: #A85C2E;" onmouseover="this.style.color='#2B1810'" onmouseout="this.style.color='#A85C2E'">
                    ...
                    <form action="{{ route('password.email') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="email" name="email" type="email" autocomplete="email" required 
                                   class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#A85C2E] focus:border-transparent transition-all duration-200 bg-white/50 backdrop-blur-sm"
                                   value="{{ old('email') }}">
                        </div>
