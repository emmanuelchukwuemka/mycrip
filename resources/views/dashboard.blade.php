    ...
    <div class="bg-gray-50 min-h-screen py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-[2.5rem] p-10 mb-10 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative">
                <div class="absolute -right-20 -top-20 w-64 h-64 bg-[#2B1810]/5 rounded-full blur-3xl"></div>
                <div class="relative z-10 text-center md:text-left">
                    <h1 class="text-3xl font-black text-[#A85C2E] tracking-tight">Welcome back, {{ explode(' ', Auth::user()->name)[0] }}! 👋</h1>
                ...
                <div class="relative z-10 flex space-x-4">
                    <a href="{{ route('properties.index') }}" class="px-6 py-3 bg-[#A85C2E] text-white font-bold rounded-2xl hover:bg-[#2B1810] transition-all shadow-xl hover:shadow-[#A85C2E]/20 active:scale-95">
                        Browse Properties
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2rem] p-8 mb-12 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-2xl font-black text-[#A85C2E]">Security Settings</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <!-- Messages Card -->
                <a href="{{ route('chat.index') }}" class="group bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-2xl hover:border-[#2B1810]/20 transition-all duration-500 transform hover:-translate-y-2 relative overflow-hidden">
                    ...
                    <h3 class="text-xl font-black text-[#A85C2E] mb-2">My Messages</h3>
                ...
                <a href="{{ route('properties.saved') }}" class="group bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-2xl hover:border-[#2B1810]/20 transition-all duration-500 transform hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-black text-[#A85C2E] mb-2">Saved Items</h3>
                ...
                <!-- Inquiries Card -->
                <a href="{{ route('inquiries.index') }}" class="group bg-white p-8 rounded-[2rem] shadow-sm border border-gray-100 hover:shadow-2xl hover:border-[#2B1810]/20 transition-all duration-500 transform hover:-translate-y-2">
                    ...
                    <h3 class="text-xl font-black text-[#A85C2E] mb-2">My Inquiries</h3>
            ...
            <div class="bg-gradient-to-br from-[#A85C2E] to-[#2B1810] rounded-[3rem] p-12 text-white shadow-2xl relative overflow-hidden">
                <div class="absolute -right-20 -bottom-20 w-96 h-96 bg-[#2B1810]/10 rounded-full blur-3xl"></div>
                ...
                <div class="relative z-10 max-w-2xl text-center md:text-left">
                    <h2 class="text-3xl font-black mb-4"><span class="text-[#2B1810]">Can't find</span> what you're looking for?</h2>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        <button class="px-8 py-4 bg-[#2B1810] text-white font-black rounded-2xl hover:bg-[#B39554] transition-all transform active:scale-95 shadow-lg shadow-[#2B1810]/20">
