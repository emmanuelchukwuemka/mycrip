...
<div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 group h-full flex flex-col">
    ...
    <div class="relative overflow-hidden flex-shrink-0">
        ...
        @if($property->is_featured && now() <= $property->featured_until)
            <div class="absolute top-4 left-4 mt-8">
                <span class="bg-gradient-to-r from-amber-400 to-amber-600 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg flex items-center">
