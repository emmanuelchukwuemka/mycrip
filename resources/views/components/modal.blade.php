...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white rounded-[2.5rem] shadow-2xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto overflow-hidden ring-1 ring-gray-900/5 animate-in zoom-in-95 duration-300"
        x-transition:enter="ease-out duration-300"
